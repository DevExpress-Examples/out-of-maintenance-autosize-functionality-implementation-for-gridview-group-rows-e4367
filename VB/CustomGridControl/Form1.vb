    ...
    Partial Public Class Form1
        ...
        Private Sub gridView1_CalcRowHeight(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowHeightEventArgs) Handles gridView1.CalcRowHeight
            If ((TryCast(sender, GridView))).IsGroupRow(e.RowHandle) Then
                ...
                Dim singleLineTextHeight As Integer = viewInfo.PaintAppearance.GroupRow.CalcTextSizeInt(viewInfo.GInfo.Cache, "Wg", 100).Height
                ...
                Dim requiredGroupRowTextHeight As Integer = viewInfo.PaintAppearance.GroupRow.CalcTextSizeInt(viewInfo.GInfo.Cache, groupRowDisplayText, requredWidth).Height
